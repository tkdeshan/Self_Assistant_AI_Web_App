    ...
    <div className="flex flex-row h-screen w-full bg-gray-100">
      <div className="h-screen w-1/5 bg-sky-900">
        <div className="flex flex-row justify-center r w-full p-3 border-b border-gray-100">
          ...
          <div className="font-serif text-2xl text-white tracking-widest ml-5 py-1">
            Tech Pack
          </div>
        </div>
        <div className="flex flex-col">
          <Link
            to="/chat"
            className="w-full flex flex-row hover:bg-slate-600 py-4 text-white text-lg"
          >
          ...
          <Link
            to="/editprofile"
            className="w-full flex flex-row hover:bg-slate-600 py-4 text-white text-lg mb-10"
          >
        ...
        <div className="flex flex-col-reverse">
          <Link
            to="/login"
            className="w-full flex flex-row hover:bg-red-900 py-4 text-white text-lg"
          >
